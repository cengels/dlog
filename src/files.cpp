...
#ifdef IS_WINDOWS
static const std::optional<const std::experimental::filesystem::path> default_path()
{
...
const std::optional<std::experimental::filesystem::path>& files::dlog_dir()
{
...
const std::optional<std::experimental::filesystem::path> files::dlog_file(const std::string& file_name)
{
